const messages = {
  hy: {
    nav: { tours: 'Տուրեր', domestic: 'Ներքին տուրեր', international: 'Արտաքին տուրեր', private: 'Անհատական', packages: 'Փաթեթներ', destinations: 'Ուղղություններ', services: 'Ծառայություններ', blog: 'Բլոգ', about: 'Մեր մասին', contact: 'Կապ' },
    common: { explore: 'Բացահայտել', viewAll: 'Տեսնել բոլորը', from: 'սկսած', book: 'Ամրագրել', details: 'Մանրամասներ', days: 'օր', reviews: 'կարծիք', readMore: 'Կարդալ', perPerson: 'մեկ անձի համար', featured: 'Ընտրված', menu: 'Մենյու' },
    ...
    forms: { name: 'Անուն', email: 'Էլ․ փոստ', phone: 'Հեռախոս', date: 'Ամսաթիվ', guests: 'Հյուրեր', message: 'Ձեր ցանկությունները', send: 'Ուղարկել հայտը', success: 'Շնորհակալություն։ Մենք շուտով կկապվենք ձեզ հետ։' },
  },
  ru: {
    nav: { tours: 'Туры', domestic: 'Туры по Армении', international: 'Зарубежные туры', private: 'Индивидуальные', packages: 'Пакеты', destinations: 'Направления', services: 'Услуги', blog: 'Блог', about: 'О нас', contact: 'Контакты' },
    common: { explore: 'Открыть', viewAll: 'Смотреть все', from: 'от', book: 'Забронировать', details: 'Подробнее', days: 'дней', reviews: 'отзывов', readMore: 'Читать', perPerson: 'за человека', featured: 'Избранное', menu: 'Меню' },
    ...
    forms: { name: 'Имя', email: 'Эл. почта', phone: 'Телефон', date: 'Дата', guests: 'Гости', message: 'Ваши пожелания', send: 'Отправить заявку', success: 'Спасибо! Мы скоро свяжемся с вами.' },
  },
  en: {
    nav: { tours: 'Tours', domestic: 'Armenia tours', international: 'Outbound tours', private: 'Private', packages: 'Packages', destinations: 'Destinations', services: 'Services', blog: 'Journal', about: 'About', contact: 'Contact' },
    common: { explore: 'Explore', viewAll: 'View all', from: 'from', book: 'Book now', details: 'Details', days: 'days', reviews: 'reviews', readMore: 'Read story', perPerson: 'per person', featured: 'Featured', menu: 'Menu' },
    ...
    forms: { name: 'Name', email: 'Email', phone: 'Phone', date: 'Date', guests: 'Guests', message: 'Your wishes', send: 'Send request', success: 'Thank you! We’ll be in touch shortly.' },
  },
}
